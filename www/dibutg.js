...
document.writeln("<img src=\'https://cdn.jsdelivr.net/gh/fulidhw/cdn/static/nav/icon/md.jpg\' style=\'width:100%; height:100%;\' alt=\'\' />");
document.writeln("</div>");
document.writeln("<div class=\'bottom-text\' id=\'bottomText\'>麻豆原創</div>");
document.writeln("<div class=\'bottom-wenan\' id=\'\'>性感萝莉主播，<span style=\'color:yellow;\'>任</span>你超控！</div>");
document.writeln("<div class=\'bottom-btn\'>立即下载</div>");
document.writeln("</div>");
document.writeln("<a id=\'bottomLink\' href=\'http://mdapp6.site/?_c=xzs00005\' target=\'_blank\'></a>");
document.writeln("</div>");
}
