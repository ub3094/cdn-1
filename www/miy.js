...
document.writeln("<img src=\'https://cdn.jsdelivr.net/gh/fulidhw/cdn/static/nav/GIF/1.gif\' style=\'width:100%; height:100%;\' alt=\'\' />");
document.writeln("</div>");
document.writeln("<div class=\'bottom-text\' id=\'bottomText\'>麻豆旗下直播</div>");
...
document.writeln("</div>");
document.writeln("<a id=\'bottomLink\' href=\'https://dl-package.ecxydn.com/android/1/2/4/QD88.apk' target=\'_blank\'></a>");
document.writeln("</div>");
}
