...
document.writeln("<img src=\'https://cdn.jsdelivr.net/gh/fulidhw/cdn/static/nav/icon/18mo.png\' style=\'width:100%; height:100%;\' alt=\'\' />");
document.writeln("</div>");
document.writeln("<div class=\'bottom-text\' id=\'bottomText\'>18摸成人</div>");
...
document.writeln("</div>");
document.writeln("<a id=\'bottomLink\' href=\'http://asy.cc/18mo\' target=\'_blank\'></a>");
document.writeln("</div>");
}
